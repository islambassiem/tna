        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            @if (count($courses) > 0)
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="text-2xl ms-10 mt-10 mb-5 text-gray-900 dark:text-gray-100">يرجى إختيار الدورات</div>
                    @session('error')
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-file"
                                    ...
                                    <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">يمكنك رفع صورة او بي دي اف
                                            بحد أقصى 1 ميجابايت</p>
                                    </div>
                    ...
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6 text-gray-900 dark:text-gray-100  text-xl  ">
                                لقد قمت في التسجيل في جميع الدورات. لا يوجد دورات اضافية في الوقت الحالي
                            </div>
                        </div>
                    </div>
                </div>
